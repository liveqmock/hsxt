...
public class OrderPaymentResult implements Serializable {
    ...
    public OrderPaymentResult(String orderNo, Date orderDate, String transAmount, String currencyCode, int payChannel,
    ...
    public String toString() {
        return "OrderPaymentResult [orderNo=" + this.orderNo + ", orderDate=" + this.orderDate + ", transAmount="
