...
public class PagePlugin implements Interceptor {
    ...
    private String generatePageSql(String sql, Page page) {
        if (page != null && (dialect != null && !"".equals(dialect)))
        {
            ...
            {
                pageSql.append(sql);
                pageSql.append(" limit ").append(currentResultIndex).append(",").append(page.getPageSize());
            }
    ...
    public void setProperties(Properties p) {
        ...
        HsAssert.hasText(dialect, BSRespCode.BS_PARAMS_EMPTY,"dialect property is not found!");

        pageSqlId = p.getProperty("pageSqlId");
        HsAssert.hasText(pageSqlId, BSRespCode.BS_PARAMS_EMPTY,"pageSqlId property is not found!");
    }
