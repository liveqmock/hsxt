 ...
 *
 * @Package :com.gy.hsxt.bs.common.handler
 * @ClassName : StringForDateTimeTypeHandler
...
public class StringForDateTimeTypeHandler extends BaseTypeHandler<String> {
    ...
    public String getNullableResult(ResultSet resultSet, String s) throws SQLException {
        ...
        return date == null ? null : DateUtil.DateTimeToString(date);
    }
