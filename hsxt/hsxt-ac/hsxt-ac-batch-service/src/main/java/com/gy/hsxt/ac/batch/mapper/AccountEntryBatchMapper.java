package com.gy.hsxt.ac.batch.mapper;
 ...
 * 
 */
public interface AccountEntryBatchMapper {
     ...
     * @throws SQLException
     */
    public List<AccountEntry> seachAccEntryListPageByTransType(Map<String,Object> accountEntryMap) throws SQLException;
