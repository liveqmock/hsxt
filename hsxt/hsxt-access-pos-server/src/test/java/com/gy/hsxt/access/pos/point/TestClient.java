...
public class TestClient {  
    public void connect(String host, int port, final String requestType)  
            throws Exception {  
        EventLoopGroup workerGroup = new NioEventLoopGroup();  
        String msg = "Are you ok?";  
        if ("SOCKET".equals(requestType)) {  
            try {  
                ...
                b.handler(new ChannelInitializer<SocketChannel>() {  
                    ...
                    protected void initChannel(SocketChannel ch)  
                        ...
                        ch.pipeline().addLast("decode", new LengthFieldPrepender(4));  
        ...
        } else if ("HTTP".equals(requestType)) {  
    ...
    public static void main(String[] args) throws Exception {  
        ...
        client.connect("127.0.0.1", 8001, "SOCKET");  
    }  
}  
