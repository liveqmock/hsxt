 ...
 * @version 1.0
 */
public class ReportsAccountEntry implements Serializable{

	private static final long serialVersionUID = 787490027418494565L;
	...
	public String getSourceTransAmount() {
		return convert(sourceTransAmount);
	}

	/**
	 * @param 订单金额 the sourceTransAmount to set
	 */
