...
import com.gy.hsxt.access.web.scs.services.safeSet.ISecuritySetService;
...
public class SecuritySetController extends BaseController {
    ...
    public HttpRespEnvelope getQuestionList(HttpServletRequest request, SCSBase scsBase) {
        ...
        try
        {
            ...
            // 2、获取密保列表
            hre = new HttpRespEnvelope(securitySetService.getQuestionList(scsBase));
        }
        catch (Exception e)
        {
    ...
    public HttpRespEnvelope getReserveInfo(HttpServletRequest request, SCSBase scsBase) {
        HttpRespEnvelope hre = null;
        ...
        try
        {
            ...
            super.verifySecureToken(request);
            // 2、返回预留信息内容
            hre = new HttpRespEnvelope(securitySetService.getReserveInfo(scsBase));
        }
        catch (Exception e)
        {
            // 异常信息封装
