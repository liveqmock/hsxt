...
*/
package com.gy.hsxt.access.web.scs.services.systemmanage.impl;
...
import com.gy.hsxt.access.web.scs.services.systemmanage.RoleService;
...
public class RoleServiceImpl extends BaseServiceImpl implements RoleService {
    ...
    public PageData findScrollResult(Map filterMap, Map sortMap, Page page) throws HsException {
        ...
        return iuCAsRoleService.listRoleByPage(platformCode, subSystemCode, roleType, entCustId,custType, page);
    }
