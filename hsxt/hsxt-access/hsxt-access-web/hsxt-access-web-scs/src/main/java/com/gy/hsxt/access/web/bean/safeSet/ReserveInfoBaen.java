 ...
 * 
 * @author: wangjg
 * @date: 2015-11-2 下午7:59:25
 * @version V1.0
 */
public class ReserveInfoBaen extends AbstractSCSBase implements Serializable {
    ...
    public void validateEmptyData() {
        RequestUtil.verifyParamsIsNotEmpty(
              new Object[] { this.reserveInfo, RespCode.AS_PARAM_INVALID }
        );
    }
