...
import com.gy.hsxt.access.web.scs.services.resoucemanage.IResouceQuotaService;
...
public class PersonResStatisticsController extends BaseController {
    ...
    public HttpRespEnvelope personResDetail(HttpServletRequest request,SCSBase scsBase) {
        ...
        try
        {
            ...
            //查询消费者统计详情
            Map<String, Object> rrs= iResouceQuotaService.personResDetail(scsBase);
