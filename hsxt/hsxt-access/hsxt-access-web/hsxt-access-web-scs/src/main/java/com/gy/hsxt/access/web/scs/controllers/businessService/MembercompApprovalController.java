...
public class MembercompApprovalController extends BaseController {
    ...
    public HttpRespEnvelope approval(HttpServletRequest request,@ModelAttribute MemberQuitApprParam param) {
        // Token验证
        HttpRespEnvelope httpRespEnvelope = super.checkSecureToken(request);
        if (httpRespEnvelope == null)
        {
