...
import com.gy.hsxt.access.web.scs.services.accountManagement.IHsbAccountDetailService;
...
public class HsbAccountDetailController extends BaseController {
	...
	public HttpRespEnvelope queryAnnualFeeOrder(String transNo,
		...
		try {
			...
			// 获取年费订单详情
			AnnualFeeOrder annualFeeOrder = service.queryAnnualFeeOrder(transNo);
