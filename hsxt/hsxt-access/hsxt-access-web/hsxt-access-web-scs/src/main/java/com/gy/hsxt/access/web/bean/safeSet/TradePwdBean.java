 ...
 * 
 * @author: wangjg
 * @date: 2015-11-2 下午7:59:36
 * @version V1.0
 */
public class TradePwdBean extends AbstractSCSBase implements Serializable {
    ...
    public void addValidate() {
        ...
        new Object[] { this.newTradingPassword, RespCode.AS_PARAM_INVALID },

        new Object[] { this.confirmTradingPassword, RespCode.AS_PARAM_INVALID });
    }
    ...
    public void updateValidate() {
        ...
        new Object[] { this.oldTradingPassword, RespCode.AS_PARAM_INVALID }
    ...
    public void resetValidate() {
        ...
        new Object[] { this.authCode, RespCode.AS_PARAM_INVALID }
