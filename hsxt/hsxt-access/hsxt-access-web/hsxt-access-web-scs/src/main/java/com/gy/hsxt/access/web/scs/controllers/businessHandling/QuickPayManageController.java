...
import com.gy.hsxt.access.web.scs.services.businessHandling.IQuickPayManageService;
...
public class QuickPayManageController extends BaseController<QuickPayManageController> {
	...
	public HttpRespEnvelope openQuickPay(HttpServletRequest request)
	{
		...
		if (httpRespEnvelope == null)
		{
			...
			RequestUtil.verifyParamsIsNotEmpty(
					new Object[] { orderNo, RespCode.EW_TOOL_ORDERNO_INVALID.getCode(),
							RespCode.EW_TOOL_ORDERNO_INVALID.getDesc() },
					new Object[] { entCustId, RespCode.AS_CUSTID_INVALID.getCode(),
							RespCode.AS_CUSTID_INVALID.getDesc() }, new Object[] { bankCardNo,
							RespCode.AS_BANKCARDNO_INVALID.getCode(), RespCode.AS_BANKCARDNO_INVALID.getDesc() },
					new Object[] { bankCardType, RespCode.AS_BANKCARDTYPE_INVALID.getCode(),
							RespCode.AS_BANKCARDTYPE_INVALID.getDesc() }, new Object[] { bankId,
							RespCode.AS_BANKID_INVALID.getCode(), RespCode.AS_BANKID_INVALID.getDesc() });
			try
			{
	...
	public HttpRespEnvelope sendQuickPaySms(HttpServletRequest request)
	{
		...
		if (httpRespEnvelope == null)
		{
			...
			RequestUtil.verifyParamsIsNotEmpty(new Object[] { orderNo, RespCode.EW_TOOL_ORDERNO_INVALID.getCode(),
					RespCode.EW_TOOL_ORDERNO_INVALID.getDesc() }, new Object[] { bindingNo,
					RespCode.EW_BINDINGNO_INVALID.getCode(), RespCode.EW_BINDINGNO_INVALID.getDesc() });
			try
			{
