...
public class ImportantInfoController extends BaseController {
     ...
     * @return
     */
    @RequestMapping(value = { "/findSamplePictureId" }, method = { RequestMethod.GET, RequestMethod.POST }, produces = "application/json;charset=UTF-8")
    @ResponseBody
    public HttpRespEnvelope findSamplePictureId(HttpServletRequest request) {
        HttpRespEnvelope hre = null;
        ...
        try
        {
            ...
            map.put("lrCredentialFrontFileId", scsConfigService.getLrCredentialFrontFileId());
            map.put("lrCredentialBackFileId", scsConfigService.getLrCredentialBackFileId());
            map.put("busLicenceFileId", scsConfigService.getBusLicenceFileId());
            map.put("taxplayerFileId", scsConfigService.getTaxplayerFileId());
            map.put("organizationFileId", scsConfigService.getOrganizationFileId());
            map.put("powerOfAttorneyFileId", scsConfigService.getPowerOfAttorneyFileId());
            map.put("applyFileId", scsConfigService.getApplyFileId());
