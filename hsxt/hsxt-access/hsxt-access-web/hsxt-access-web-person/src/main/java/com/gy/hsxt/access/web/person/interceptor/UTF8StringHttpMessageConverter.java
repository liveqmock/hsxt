package com.gy.hsxt.access.web.person.interceptor;
 ...
 * @package           com.gy.hsxt.access.web.person.utils.UTF8StringHttpMessageConverter.java
 * @className       UTF8StringHttpMessageConverter
 * @description      一句话描述该类的功能 
 * @author              LiZhi Peter
 * @createDate       2015-8-11 下午4:26:09  
 * @updateUser      LiZhi Peter
 * @updateDate      2015-8-11 下午4:26:09
