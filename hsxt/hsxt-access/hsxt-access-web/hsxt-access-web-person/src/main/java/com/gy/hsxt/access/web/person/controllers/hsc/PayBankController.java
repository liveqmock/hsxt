...
import com.gy.hsxt.access.web.person.services.hsc.IPayBankService;
...
public class PayBankController extends BaseController {
    ...
    public HttpRespEnvelope findPayBanksByCustId(HttpServletRequest request) {
        try {
            ...
            RequestUtil.verifyParamsIsNotEmpty(
                new Object[] {custId, ASRespCode.AS_CUSTID_INVALID}
            );
            Map<String, Object> map = new HashMap<String, Object>();
            //查询绑定的银行列表
            map.put("banks", this.payBankService.findPayBanksByCustId(custId));
            //获取最大绑定的银行卡数
    ...
    public HttpRespEnvelope addPayBank(HttpServletRequest request, @ModelAttribute AsQkBank bank) {
        try {
            ...
            //非空验证
            RequestUtil.verifyParamsIsNotEmpty(
                new Object[] {bank.getCustId(), ASRespCode.AS_CUSTID_INVALID},
