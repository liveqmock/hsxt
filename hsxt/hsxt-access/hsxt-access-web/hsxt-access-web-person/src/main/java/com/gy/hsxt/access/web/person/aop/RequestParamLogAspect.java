 ...
 */
package com.gy.hsxt.access.web.person.aop;
...
import com.gy.hsxt.access.web.person.interceptor.SystemControllerLog;
 ...
 * 
 * Package Name     : com.gy.hsxt.access.web.person.interceptor  
 * 
...
public class RequestParamLogAspect {
    ...
    // Controller层切点
    @Pointcut("execution(* com.gy.hsxt.access.web.person.controllers.*.*Controller.*(..))")
