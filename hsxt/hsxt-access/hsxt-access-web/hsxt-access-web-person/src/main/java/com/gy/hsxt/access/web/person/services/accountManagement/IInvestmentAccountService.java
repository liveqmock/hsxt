...
public interface IInvestmentAccountService extends IBaseService {
	 ...
	 * @throws HsException
	 */
	public CustomPointDividend findInvestDividendInfo(String hsResNo,
			String dividendYear) throws HsException;
	 ...
	 * @throws HsException
	 */
	public PageData<PointInvest> pointInvestPage(Map filterMap, Map sortMap,
	 ...
	 * @throws HsException
	 */
	public PageData<PointDividend> pointDividendPage(Map filterMap,
	 ...
	 * @throws HsException
	 */
	public PageData<DividendDetail> dividendDetailPage(Map filterMap,
			Map sortMap, Page page) throws HsException;
