 ...
 * @package       : com.gy.hsxt.access.web.person.services.hsc
 * @className     : ImportantInfoChangeService.java
...
@Service
public class ImportantInfoChangeService extends BaseServiceImpl implements IImportantInfoChangeService {
    
    @Autowired
    private IBSChangeInfoService bsService;//重要信息变更服务类
	...
	public PerChangeInfo queryPerChangeByCustId(String custId) {
		return this.bsService.queryPerChangeByCustId(custId);
	}
	...
	public void createPerChange(PerChangeInfo info) throws HsException {
		this.bsService.createPerChange(info);
	}
	...
	public void modifyPerChange(PerChangeInfo info) throws HsException {
		this.bsService.modifyPerChange(info);
	}
