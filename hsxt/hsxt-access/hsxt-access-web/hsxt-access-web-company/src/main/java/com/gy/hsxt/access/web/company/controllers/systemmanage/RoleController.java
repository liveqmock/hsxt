...
public class RoleController extends BaseController {
    ...
    public HttpRespEnvelope add(HttpServletRequest request, @ModelAttribute AsRole role) {
        try {
            ...
            //设置子系统编码
            role.setSubSystemCode(SubSysEnum.COMPANY.name());
            //操作者客户号
            ...
            RequestUtil.verifyParamsIsNotEmpty(
                ...
                new Object[] {role.getRoleDesc(), RespCode.MW_ROLE_ROLEDESC},
                new Object[] {role.getRoleName(), RespCode.MW_ROLE_ROLENAME}
            );
            String roleId = asRoleService.addRole(role, adminCustId);
    ...
    public HttpRespEnvelope delete(HttpServletRequest request) {
        try {
            ...
            asRoleService.deleteRole(roleId, adminCustId);
    ...
    public HttpRespEnvelope update(HttpServletRequest request, @ModelAttribute AsRole role) {
        try {
            ...
            asRoleService.updateRole(role, adminCustId);
            return new HttpRespEnvelope();
        } catch (HsException e) {
            return new HttpRespEnvelope(e);
        }
    ...
    public HttpRespEnvelope grantRole(HttpServletRequest request) {
        try {
            ...
            asRoleService.grantRole(operCustId, list, adminCustId);
    ...
    public HttpRespEnvelope resetRole(HttpServletRequest request) {
        try {
            ...
            asRoleService.resetRole(operCustId, list, adminCustId);
    ...
    public HttpRespEnvelope roleList(HttpServletRequest request) {
        try {
            ...
            List<AsRole> listRole = asRoleService.listRole(platformCode, subSystemCode,roleType2, entCustId,custType);
