...
public class SecuritySetService extends BaseServiceImpl implements ISecuritySetService {
     ...
     */
    @Override
    public List<AsPwdQuestion> getQuestionList(CompanyBase companyBase) throws HsException {
        // 获取密保问题
     ...
     */
    @Override
    public String getReserveInfo(CompanyBase companyBase) throws HsException {
        // 查询预留信息
        return ucAsReserveInfoService.findReserveInfoByCustId(companyBase.getEntCustId(), UserTypeEnum.ENT
                .getType());
