...
public interface IBalanceService extends IBaseService {
	 ...
	 * @throws HsException
	 */
	public AccountEntrySum findPerIntegralByYesterday(String custId,
	 ...
	 * @throws HsException
	 */
	public PageData<QueryEntry> proceedsEntryList(Map filterMap, Map sortMap,
			Page page) throws HsException;
	/**
	 * 查询网上商城销售收入详情流水
	 * 
	 ...
	 * @throws HsException
	 */
	public PageData<QueryEntry> proceedsOnLineEntryList(Map filterMap, Map sortMap,
			Page page) throws HsException;
