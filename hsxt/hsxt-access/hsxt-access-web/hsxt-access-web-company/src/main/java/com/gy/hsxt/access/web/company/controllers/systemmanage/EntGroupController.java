...
import com.gy.hsxt.access.web.company.services.systemmanage.EntGroupService;
...
public class EntGroupController extends BaseController {
    ...
    public HttpRespEnvelope addGroupUser(HttpServletRequest request) {
        try {
            ...
            entGroupService.addGroupUser(operCustIds, Long.parseLong(groupId), adminCustId);
