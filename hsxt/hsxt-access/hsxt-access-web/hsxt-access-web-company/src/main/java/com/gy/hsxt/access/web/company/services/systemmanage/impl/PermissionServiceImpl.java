...
public class PermissionServiceImpl extends BaseServiceImpl implements PermissionService {
    ...
    @Override
    public List<AsPermission> listPerm(String platformCode, String subSystemCode, Short permType, String parentId,String entResType)
            throws HsException {
        
        return iuCAsPermissionService.listPerm(platformCode, subSystemCode, permType, parentId,entResType);
    }
