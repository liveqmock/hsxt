 ...
 * 值班计划实体类
 * @Package: com.gy.hsxt.access.web.bean.workflow  
 * @ClassName: McsScheduleBean 
 * @Description: TODO
 *
 * @author: wangjg 
 * @date: 2016-1-29 下午6:42:12 
 * @version V1.0
 */
public class McsScheduleBean implements Serializable {

    private static final long serialVersionUID = 2859723454460824579L;
    ...
    public void checkData() {
        RequestUtil.verifyParamsIsNotEmpty(new Object[] { this.scheduleJson, ASRespCode.MW_SCHEDULE_NOT_NULL });

        // 值班计划不能为空
        if (schedule == null || schedule.getScheduleOptList() == null || schedule.getScheduleOptList().size() == 0)
        {
            throw new HsException(ASRespCode.MW_SCHEDULE_NOT_NULL);
        }
    }
