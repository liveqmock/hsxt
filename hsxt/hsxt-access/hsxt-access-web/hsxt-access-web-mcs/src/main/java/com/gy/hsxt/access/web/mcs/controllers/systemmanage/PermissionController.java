...
import com.gy.hsxt.access.web.mcs.services.systemmanage.PermissionService;
...
public class PermissionController extends BaseController {
    ...
    public HttpRespEnvelope listPerm(HttpServletRequest request) {
        try {
            ...
            List<AsPermission> list = permissionService.listPerm(platformCode, subSystemCode, type, parentId);
