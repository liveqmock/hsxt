 ...
 */
package com.gy.hsxt.access.web.mcs.aop;
 ...
 * Description 		: 切点类 
 * 
 * Project Name   	: hsxt-access-web-mcs 
 * 
 * Package Name     : com.gy.hsxt.access.web.mcs.aop
 * 
...
public class RequestParamLogAspect {
    ...
    // Controller层切点
    @Pointcut("execution(* com.gy.hsxt.access.web.mcs.controllers.*.*Controller.*(..))")
