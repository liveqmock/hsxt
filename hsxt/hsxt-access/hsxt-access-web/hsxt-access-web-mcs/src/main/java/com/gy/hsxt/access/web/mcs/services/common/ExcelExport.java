...
import com.gy.hsxt.access.web.mcs.controllers.workflow.ScheduleExportPersonalized;
...
public final class ExcelExport implements Serializable {
    ...
    public static void main(String[] args) {
        McsMembersScheduleBean amsb = new McsMembersScheduleBean();
        amsb.setYear("2016");
        amsb.setMonth("1");
        ...
        McsScheduleExprotDataInit asedi = new McsScheduleExprotDataInit(amsb, oMap);

        ExcelExport ee = new ExcelExport();
        HSSFWorkbook wb = ee.createExcel("测试", asedi.columnNum, asedi.cellTitle, asedi.content);
