...
public class OperatorServiceImpl extends BaseServiceImpl implements OperatorService {
     ...
     * @param mcsBase
     * @return 
     * @see com.gy.hsxt.access.web.mcs.services.systemmanage.OperatorService#getOperatorDetail(com.gy.hsxt.access.web.bean.MCSBase)
     */
    @Override
    public Map<String, Object> getOperatorDetail(MCSBase mcsBase) {
        //查询操作员信息
       AsOperator ao= iUCAsOperatorService.searchOperByCustId(mcsBase.getCustId());
       
       //查询企业所有信息
       AsEntAllInfo aea=iuCAsEntService.searchEntAllInfo(mcsBase.getEntCustId());
