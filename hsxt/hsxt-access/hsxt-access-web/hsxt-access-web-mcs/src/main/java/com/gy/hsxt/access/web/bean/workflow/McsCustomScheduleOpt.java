 ...
 * 值班计划扩展类
 * @Package: com.gy.hsxt.access.web.bean.workflow  
 * @ClassName: McsCustomScheduleOpt 
 * @Description: TODO
 *
 * @author: wangjg 
 * @date: 2016-1-29 下午6:42:57 
 * @version V1.0
 */
public class McsCustomScheduleOpt extends CustomScheduleOpt implements Serializable {
    private static final long serialVersionUID = -415560361560481788L;
    ...
    public void checkData() {
        ...
        RequestUtil.verifyParamsIsNotEmpty(
                // 值班组编号
                new Object[] { cso.getGroupId(), ASRespCode.MW_GROUP_ID_NOT_NULL },
                // 排班年份
                new Object[] { cso.getPlanYear(), ASRespCode.MW_SELECT_YEAR },
                // 排班月份
                new Object[] { cso.getPlanMonth(), ASRespCode.MW_SELECT_MONTH }
        );
    }
