 ...
 * 值班员业务类型实体
 * @Package: com.gy.hsxt.access.web.bean.workflow  
 * @ClassName: McsBizTypeAuthBean 
 * @Description: TODO
 *
 * @author: wangjg 
 * @date: 2016-1-29 下午6:43:54 
 * @version V1.0
 */
public class McsBizTypeAuthBean implements Serializable {
    private static final long serialVersionUID = 3725490656854393761L;
    ...
    public void checkData() {
        ...
        RequestUtil.verifyParamsIsNotEmpty(new Object[] { this.bizTypeJson, ASRespCode.MW_SELECT_MEMBER_BIZTYPE });

        // 值班组组员业务类型不能少于一条
        if (this.btaList == null || this.btaList.size() == 0)
        {
            throw new HsException(ASRespCode.MW_SELECT_MEMBER_BIZTYPE);
        }
    }
