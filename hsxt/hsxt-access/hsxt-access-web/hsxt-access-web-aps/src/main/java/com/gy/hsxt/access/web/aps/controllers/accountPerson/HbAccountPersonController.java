 ...
 ***************************************************************************/
@Controller
@RequestMapping("hbAccountPerson")
public class HbAccountPersonController extends BaseController {
	@Resource
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/hb_detailed_page" }, method = { RequestMethod.GET, RequestMethod.POST }, produces = "application/json;charset=UTF-8")
     ...
     */
    @ResponseBody
    @RequestMapping(value = { "/sum_hb_detailed_page" }, method = { RequestMethod.GET, RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	 ...
	 */
	@ResponseBody
	@RequestMapping(value = { "/get_hb_acc_opt_detailed" }, method = { RequestMethod.GET, RequestMethod.POST }, produces = "application/json;charset=UTF-8")
