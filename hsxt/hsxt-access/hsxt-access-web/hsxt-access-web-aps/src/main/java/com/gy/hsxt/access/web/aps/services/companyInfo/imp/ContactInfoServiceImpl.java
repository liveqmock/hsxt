...
@Service
public class ContactInfoServiceImpl extends BaseServiceImpl implements IContactInfoService{
	...
	public void validEmail(String email, String userName, String entResNo, String userType) throws HsException {
		ucEmailService.sendMailForValidEmail(email, userName, entResNo, userType,  CustType.AREA_PLAT.getCode());
	}
