...
import com.gy.hsxt.access.web.bean.workflow.ApsToDoBean;
...
public class WorkOrderServiceImpl extends BaseServiceImpl implements IWorkOrderService {
    ...
    public PageData<?> workOrderPage(Map filterMap, Map sortMap, Page page) throws HsException {
        // 1、构建查询实体
        TmBaseParam tbp = this.createTmBaseParam(filterMap);
     ...
     * @param apsToDo
     * @throws HsException
     * @see com.gy.hsxt.access.web.aps.services.workflow.IWorkOrderService#toDo(com.gy.hsxt.access.web.bean.workflow.ApsToDoBean)
     */
    @Override
    public void toDo(ApsToDoBean apsToDo) throws HsException {
        // 创建BaseBean
     ...
     * @param asub
     * @throws HsException
     * @see com.gy.hsxt.access.web.aps.services.workflow.IWorkOrderService#updateStatus(com.gy.hsxt.access.web.bean.workflow.ApsStatusUpdateBean)
     */
    @Override
    public void updateStatus(ApsStatusUpdateBean asub) throws HsException {
        // 1、验证复合操作员权限
        // ucLoginService.operatorAuth(asub.createOperatorLoginInfo(),
        // ConstantURLAuth.RECEIV_MANAGE_CLOSE_ORDER);
     ...
     * @param asub
     * @throws HsException
     * @see com.gy.hsxt.access.web.aps.services.workflow.IWorkOrderService#reminders(com.gy.hsxt.access.web.bean.workflow.ApsStatusUpdateBean)
     */
    @Override
    public void reminders(ApsStatusUpdateBean asub) throws HsException {
        // 调用催办接口
     ...
     * @return
     * @throws HsException
     * @see com.gy.hsxt.access.web.aps.services.workflow.IWorkOrderService#getAttendantList(com.gy.hsxt.access.web.bean.ApsBase,
     *      java.util.List)
     */
    @Override
    public List<Operator> getAttendantList(ApsBase apsBase, List<String> bizType) throws HsException {
        // 获取值班人员
        return itmOnDutyService.getOperatorListByCustId(apsBase.getEntCustId(), bizType);
    }
    ...
    public List<BizType> getBizAuthList() {
        return itmBizAuthService.getBizAuthList(CustType.AREA_PLAT.getCode());
    }
     ...
     * @param applyId
     * @return 
     * @see com.gy.hsxt.access.web.aps.services.workflow.IScheduleService#getTmTaskByBizNo(java.lang.String)
     */
    @Override
    public TmTask getTmTaskByBizNo(String applyId) {
        return itmTaskService.getTmTaskByBizNo(applyId);
    }
     ...
     * @return
     */
    BaseBean createBaseBean(ApsToDoBean apsToDo) {
