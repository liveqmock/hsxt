...
public interface IScheduleService extends IBaseService {
     ...
     * @return
     */
    public List<Map<String, String>> getListOperByEntCustId(ApsBase apsBase) throws HsException;
     ...
     * @return
     */
    public ApsScheduleExprotDataInit export(ApsMembersScheduleBean amsb) throws HsException;
