...
public class EntGroupServiceImpl extends BaseServiceImpl implements EntGroupService {
    ...
    public PageData findScrollResult(Map filterMap, Map sortMap, Page page) throws HsException {
        ...
        String groupName = (filterMap.get("groupName") == null || "".equals(filterMap.get("groupName")))?null:filterMap.get("groupName").toString();
        return iuCAsEntGroupService.listGroup(entCustId,groupName, page);
    }
