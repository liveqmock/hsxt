...
public class WorkOrderController extends BaseController {
    ...
    public HttpRespEnvelope termination(HttpServletRequest request, ApsStatusUpdateBean asub) {
        HttpRespEnvelope hre = null;
    ...
    public HttpRespEnvelope toDo(HttpServletRequest request, ApsToDoBean apsToDo) {
        HttpRespEnvelope hre = null;
        try
        {
            // 1、验证token
    ...
    public HttpRespEnvelope reminders(HttpServletRequest request, ApsStatusUpdateBean asub) {
        HttpRespEnvelope hre = null;
    ...
    public HttpRespEnvelope getAttendantList(HttpServletRequest request, ApsBase apsBase) {
        HttpRespEnvelope hre = null;
        ...
        try
        {
            ...
            // 3、获取值班员
            List<Operator> aList = iWorkOrderService.getAttendantList(apsBase,bieTypes);
     ...
     */
    @ResponseBody
    @RequestMapping(value = "getTmTaskByBizNo", method = { RequestMethod.GET, RequestMethod.POST }, produces = "application/json;charset=UTF-8")
    public HttpRespEnvelope getTmTaskByBizNo(HttpServletRequest request, String applyId) {
        ...
        try
        {
            ...
            //验证空数据
            RequestUtil.checkParamIsNotEmpty(new Object[]{ applyId, ASRespCode.AS_PARAM_INVALID  });

            // 获取工单明细
            TmTask tmTask = iWorkOrderService.getTmTaskByBizNo(applyId);
            hre = new HttpRespEnvelope(tmTask);
        }
        catch (HsException e)
        {
            hre = new HttpRespEnvelope(e);
