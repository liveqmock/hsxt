 ...
 */
@Controller
@RequestMapping("hsbPerNoCardAccount")
public class HsbAccPerNoCardController extends BaseController<Object> {
	@Resource
	private IAccountNoCarService accountNoCarService; // 非持卡人服务类
