...
public class OperatorController extends BaseController {
    ...
    public HttpRespEnvelope operatorDetail(HttpServletRequest request, ApsBase apsBase) throws IOException {
        try
        {
            //操作员登录信息
            Map<String, Object> retMap = operatorService.getOperatorDetail(apsBase);
