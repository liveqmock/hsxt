...
public class HsbAccountDetailService extends
	...
	@Autowired
    private IPsQueryService iPsQueryService;// 订单详情
    ...
    public ProxyBuyHsb getEntProxyBuyHsbInfo(String transNo) {
        return iaoExchangeHsbService.getEntProxyBuyHsbInfo(transNo);
    }
    ...
    public QueryResult singlePosQuery(QuerySingle querySingle) {
        return iPsQueryService.singlePosQuery(querySingle);
    }
    ...
    public QueryResult queryDetailsByTransNo(String transNo) {
        return iPsQueryService.queryDetailsByTransNo(transNo);
    }
     ...
     */
    @Override
    public CustomPointDividend getInvestDividendInfo(String hsResNo,String year) {
        return ibsInvestProfitService.getInvestDividendInfo(hsResNo,year);
    }
    ...
    public PageData<DividendDetail> getDividendDetailList(String hsResNo,String year,Page page) {
        return ibsInvestProfitService.getDividendDetailList(hsResNo,year,page);
    }
