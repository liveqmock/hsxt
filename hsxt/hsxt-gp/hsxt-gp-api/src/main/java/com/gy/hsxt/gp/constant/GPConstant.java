...
public class GPConstant {
	...
	public static interface PayChannel {
		...
		/** 100-平安网银支付 **/
		public static final int PA_B2C = B2C;
	}
	...
	/** 支付方式(creditPay信用支付、directPay余额支付) **/
	public static interface GPPaymentMethod {
		/** 1:信用支付 **/
		public static final int CREDIT_PAY = 1;

		/** 2:余额支付 **/
		public static final int DIRECT_PAY = 2;
	}

	/** 平安支付页面类型 **/
	public static interface PinganPaymentUIType {
