...
public class PGConstant {
	...
	/** 平安支付页面类型 **/
	public static interface PGPinganPaymentUIType {
	...
	/** 支付渠道提供商 **/
	public static interface PGChannelProvider {
		/** C-中国银联 **/
		public static final String CHINAPAY = "C";

		/** P-中国平安 **/
		public static final String PINGAN_PAY = "P";
		
		/** A-阿里支付宝 **/
		public static final String ALIPAY = "A";
		
		/** W-微信支付 **/
		public static final String WEIXIN_PAY = "W";
	}
}
