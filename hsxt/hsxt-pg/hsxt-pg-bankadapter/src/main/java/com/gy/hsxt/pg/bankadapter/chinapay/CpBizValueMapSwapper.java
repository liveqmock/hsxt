 ...
 * 
 *  File Name       : CpBizValueMapSwapper.java
 * 
 ...
 * </PRE>
 ***************************************************************************/
public class CpBizValueMapSwapper {
	/**
	 * 将银行的状态转换为ufe的'订单'类型
	 * 
	 * @param bankTransType
	...
	public static int toPgTransType(String bankTransType) {
		...
		if (BankTransType.PAY.equals(bankTransType)
			...
			return PaymentOrderTransType.TYPE_PAY.getValue();
		}
		...
		if (BankTransType.REFUND.equals(bankTransType)
			...
			return PaymentOrderTransType.TYPE_REFUND.getValue();
		}

		return PaymentOrderTransType.UNKNOWN.getValue();
	}
