...
public class UpacpOrderStateWorker extends AbstractUpacpBankWorker {
	 ...
	 * @throws Exception
	 */
	private BankPaymentOrderResultDTO getPayOrderState(String orderNo,
		...
		return parse2BankPaymentOrderResultDTO(resmap, orderNo);
	}

	/**
	 * 解析为BankPaymentOrderResultDTO对象
	 * 
	 * @param resmap
	 * @param orderNo
	 * @return
	 */
	private BankPaymentOrderResultDTO parse2BankPaymentOrderResultDTO(
		...
		bankRespParam.setOrderNoKey("orderId").setPayAmountKey("txnAmt")
				...
				.setCurrencyKey("currencyCode").setRespCodeKey("origRespCode")
