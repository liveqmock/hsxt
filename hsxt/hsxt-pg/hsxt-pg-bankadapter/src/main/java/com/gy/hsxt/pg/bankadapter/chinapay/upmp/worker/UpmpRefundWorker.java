...
public class UpmpRefundWorker extends AbstractBankWorker {
	...
	public boolean doRefund(UpmpRefundParam param) throws Exception {
		...
		reqMap.put(RefundReqParamKey.CHARSET, BanksConstants.CHARSET_UTF8);// 字符编码
	...
	public BankPaymentOrderResultDTO parseResultFromBankCallback(
		...
		int pgTransType = CpBizValueMapSwapper.toPgTransType(cbParamMap
				.get(RefundCallbackParamKey.TRANS_TYPE));
