...
import com.sdb.payclient.core.MerchantValueCache;
...
public class PropertyConfigurer extends HsPropertiesConfigurer {
	...
	protected void doCacheProperties(Properties props) {
		...
		// 缓存到第三方插件
		doCache2ThirdPart(propertiesMap);
	}
	 ...
	 * @param map
	 */
	private void doCache2ThirdPart(Map<String, String> map) {
		...
		while(itor.hasNext()) {
			...
			MerchantValueCache.setString(key, value);
		}		
	}
}