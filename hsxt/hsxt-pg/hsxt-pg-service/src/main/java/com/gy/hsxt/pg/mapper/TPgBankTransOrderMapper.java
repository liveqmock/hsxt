...
public interface TPgBankTransOrderMapper {
	 ...
	 * @return
	 */
	TPgBankTransOrder selectByBankOrderNo(String bankOrderNo);
	 ...
	 * @return
	 */
	List<TPgBankTransOrder> selectByBatchNo(String bankBatchNo);
	 ...
	 * @return
	 */
	int insert(TPgBankTransOrder record);
	 ...
	 * @return
	 */
	int updateStatusByBankOrderNo(TPgBankTransOrder record);
}