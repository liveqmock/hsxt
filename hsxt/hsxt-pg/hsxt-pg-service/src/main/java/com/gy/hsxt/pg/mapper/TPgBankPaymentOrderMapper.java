...
public interface TPgBankPaymentOrderMapper {
	 ...
	 * @return
	 */
	TPgBankPaymentOrder selectByBankOrderNo(String bankOrderNo);
	 ...
	 * @return
	 */
	List<TPgBankPaymentOrder> listByStatus(int transStatus);
	 ...
	 * @return
	 */
	int insert(TPgBankPaymentOrder record);
	 ...
	 * @return
	 */
	int updateStatusByBankOrderNo(TPgBankPaymentOrder record);
