...
import com.gy.hsxt.pg.common.bean.Counter;
...
public class TimeSecondsSeqWorker {
	 ...
	 * @return
	 */
	public static String timeNextId16() {
		synchronized ($.LEN_16) {
	 ...
	 * @return
	 */
	public static String timeNextId20() {
		synchronized ($.LEN_20) {
			// 年月日时分缩略编号, 10位
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			new Thread() {
				public void run() {
					String id16 = timeNextId16();
					String id20 = timeNextId20();
