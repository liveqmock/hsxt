...
public class TPgBankPaymentOrder {
	...
	public void setOrigBankOrderNo(String origBankOrderNo) {
		this.origBankOrderNo = origBankOrderNo == null ? null : origBankOrderNo
				.trim();
	}
	...
	public void setBankOrderStatus(String bankOrderStatus) {
		this.bankOrderStatus = bankOrderStatus == null ? null : bankOrderStatus
				.trim();
	}
	...
	public void setPrivObligate2(String privObligate2) {
		this.privObligate2 = privObligate2 == null ? null : privObligate2
				.trim();
	}
