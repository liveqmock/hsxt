 ...
 * @version V3.0
 */
public class ProceedsResult implements Serializable
{
	/**
	 * 
	 */
	...
	/** 扣除积分金额 **/
	private String deductPointAmount;
	/** 总笔数 **/
	 ...
	 * 当日退货退款额(HSB)
	 **/
	private String dayBackHsbTurnover;

	/**
	 * 当日结单退积分数
	 **/
	private String dayBackPointTurnover;

	/**
	 * 当日退货退款额(現金)
	 **/
	private String dayBackCyberTurnover;
	/**
	 * 获取交易流水号
	 *
	...
	{
		if (StringUtils.isEmpty(cscTurnover)) {
	...
	public String getDayBackHsbTurnover() {
		return dayBackHsbTurnover;
	}

	public void setDayBackHsbTurnover(String dayBackHsbTurnover) {
		this.dayBackHsbTurnover = dayBackHsbTurnover;
	}

	public String getDayBackPointTurnover() {
		return dayBackPointTurnover;
	}

	public void setDayBackPointTurnover(String dayBackPointTurnover) {
		this.dayBackPointTurnover = dayBackPointTurnover;
	}

	public String getDeductPointAmount() {
		return deductPointAmount;
	}

	public void setDeductPointAmount(String deductPointAmount) {
		this.deductPointAmount = deductPointAmount;
	}

	public String getDayBackCyberTurnover() {
		return dayBackCyberTurnover;
	}

	public void setDayBackCyberTurnover(String dayBackCyberTurnover) {
