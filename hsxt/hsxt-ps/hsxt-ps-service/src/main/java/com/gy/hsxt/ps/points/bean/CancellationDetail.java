...
public class CancellationDetail implements Serializable {
	...
	/**
	 * 获取原始币种金额
	 * @return BigDecimal sourceTransAmount
	 */
	...
	public Timestamp getUpdatedDate() {
		return updatedDate==null?updatedDate:(Timestamp) updatedDate.clone();
	}
	/**
	 * 设置修改时间
