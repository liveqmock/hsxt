...
public class RandomGuidAgent {
    ...
    /**
     * 生成全局唯一流水号(递增)。 编码规则：业务编码+唯一id+机器节点编号
     ...
     * @return
     */
    public static long  getGuid(String gourpId) {
    	return getSeqWorker(gourpId).nextId();
    ...
    public static String getStringGuid() {
        ...
        return Long.toString(defSeqWorker.nextId());
    }
    /**
     * 根据当前毫秒数获取(15位递增)唯一数字
     * 分布式多台服务器下不保证唯一
    ...
    public static void main(String args[]) {
        ...
        for (int i = 0; i < 10; i++)
        {
            System.out.println(RandomGuidAgent.getGuid("1"));
        }
        System.out.println(RandomGuidAgent.getGuid("2", null, ""));
    }
