...
public class AsEntUpdateLogNew  implements Serializable{
	
    /**
	 * 
	 */
	private static final long serialVersionUID = -134411363787827451L;
    ...
    private BigDecimal credentialType;
    ...
    private BigDecimal busiArea;

    private BigDecimal entEmpNum;
    ...
    private BigDecimal artResTypest;

    private BigDecimal modifyAcount;
    ...
    public BigDecimal getCredentialType() {
        return credentialType;
    }

    public void setCredentialType(BigDecimal credentialType) {
    ...
    public BigDecimal getBusiArea() {
        return busiArea;
    }

    public void setBusiArea(BigDecimal busiArea) {
        this.busiArea = busiArea;
    }

    public BigDecimal getEntEmpNum() {
        return entEmpNum;
    }

    public void setEntEmpNum(BigDecimal entEmpNum) {
    ...
    public BigDecimal getArtResTypest() {
        return artResTypest;
    }

    public void setArtResTypest(BigDecimal artResTypest) {
        this.artResTypest = artResTypest;
    }

    public BigDecimal getModifyAcount() {
        return modifyAcount;
    }

    public void setModifyAcount(BigDecimal modifyAcount) {
