 ...
 * @version V1.0
 */
public class AsBelongEntInfo implements Serializable {
	...
	/** 实名认证状态 1.已认证、0.未认证 */
	private Integer realNameAuthSatus;
	/** 企业启用的消费者数量 */
	 ...
	 */
	public Integer getRealNameAuthSatus() {
	 ...
	 */
	public void setRealNameAuthSatus(Integer realNameAuthSatus) {
