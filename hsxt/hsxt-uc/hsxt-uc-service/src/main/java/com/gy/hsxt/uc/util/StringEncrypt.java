...
public class StringEncrypt {
	...
	public static String string2MD5(String inStr) {
		...
		try {
			...
			SystemLog.error(MOUDLENAME, "string2MD5", "加密MD5出错：", e);
			return "";
		}
	...
	public static String sha256(String content) {
		...
		try {
			...
			SystemLog.error(MOUDLENAME, "sha256", content+","+e.getMessage(), e);
			return null;
		}
		return strDes;
	}
...
//		String nPwd = "11111111";
//		String salt = "6d81f31b55508a8b";//CSPRNG.generateRandom(8);
//		String md5 = StringEncrypt.string2MD5(nPwd);
//		md5 = md5 +salt;
//		md5 = StringEncrypt.sha256(md5);
//		System.out.println(md5);
//		String s = StringEncrypt.encrypt("11111111", "1");
//		System.out.println(s);
//		syso
//		System.out.println("salt["+salt+"],pwd["+md5+"]" );
//		String s = StringEncrypt.encrypt("111111", "98366370cdd6afc2");
//		System.out.println(s);
//		String s = StringEncrypt.decrypt("28qAPMcJxQRESP6IiRkclQ==", "3222d8c976cb00ae");
//		String password = StringEncrypt.string2MD5("11111111");
//		System.out.println(StringEncrypt.sha256(password + "6d81f31b55508a8b"));
		
		//StringEncrypt.computeWebTranPwd();
		System.out.println(StringEncrypt.encrypt("666666", "112457c3a5caf24e"));
	}
	
	public static void computeWebTranPwd(){
		String plantPwd = "11111111";
		String token = "6d81f31b55508a8b";
