...
$(document).ready(function(){
	...
	var remoteTable = $('#remote-data-table').DataTable({
		"jQueryUI": true,
		"pagingType": "full_numbers",
		"dom": '<""l>t<"F"fp>',
		"processing": true,
		"serverSide": true,
		"ajax": Root + '/remote/queryRemoteNotifyForPage',
	...
	//初始化任务触发事件
	$('#remote-data-table tbody').on("click", ".resend", function () {
		var rowData = remoteTable.row(this.parentNode.parentNode).data();
		$.ajax({
			url: Root + "/remote/touchRemoteNotifyJobByNotifyNo",
			type: 'POST',
