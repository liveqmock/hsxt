...
<!--Header-part-->
<div id="header">
    <h1><a href="${path}/dashboard.html">Matrix Admin</a></h1>
</div>
<!--close-Header-part-->
    ...
    <ul class="nav">
        <li class="dropdown" id="profile-messages"><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="icon icon-user"></i> <span class="text">Welcome User</span><b
            ...
            <ul class="dropdown-menu">
                ...
                <li class="divider"></li>
                <li><a href="../login/login.jsp"><i class="icon-key"></i> Log Out</a></li>
            </ul>
        </li>
        ...
        <li class=""><a title="" href="../login/login.jsp"><i class="icon icon-share-alt"></i> <span class="text">Logout</span></a></li>
    </ul>
</div>
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-th"></i>Local Notifies</a>
    <ul>
        <li><a href="${path}/index.jsp"><i class="icon icon-home"></i> <span>Home</span></a></li>
        <li class="active"><a href="local.jsp"><i class="icon icon-th"></i> <span>Local Notifies</span></a></li>
        <li><a href="remote.jsp"><i class="icon icon-th"></i> <span>Remote Notifies</span></a></li>
    </ul>
</div>
<div id="content">
    <div id="content-header">
        <div id="breadcrumb"><a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Local Notifies</a></div>
        <h1>Local Notifies</h1>
    </div>
            ...
            <div class="span12">
                <div class="widget-box">
                    ...
                    <div class="widget-content nopadding">
                        <table id="local-data-table" class="table table-bordered">
                            <thead>
                            <tr>
                                <th>no</th>
                                <th>notifyNo</th>
                            ...
                            <tbody>
                            <tr>
                                <td colspan="12">sorry,no data !</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
...
<script src="${path}/js/notify/local.js"></script>
</body>
</html>
