define(['text!accountManageTpl/jfzh/jfzhye/jfzhye.html' ],function(jfzhyeTpl ){
	return {
 
		showPage : function(tabid){
			$('#main-content > div[data-contentid="'+tabid+'"]').html(_.template(jfzhyeTpl)) ;
		    
		    
		    
		    $('#btnNew').triggerTab(200101);
