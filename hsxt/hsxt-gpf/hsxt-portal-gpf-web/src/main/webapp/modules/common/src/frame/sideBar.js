define(["text!commTpl/frame/sideBar.html", "commSrc/frame/menu", "commDat/frame/menu"], function (tpl, menu, menuAjax) {

    menuAjax.queryMenuList(function (menuList) {
        //加载左边导航栏
        $('#menu-box').empty().html(_.template(tpl, {menuList: menuList}));
