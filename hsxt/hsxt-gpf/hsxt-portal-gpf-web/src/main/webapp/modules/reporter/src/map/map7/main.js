define(['text!reporterTpl/map/map7/line.html'  ,'echarts',
...
require('echarts/util/mapData/params').params.USA = {
    getGeoJson: function (callback) {
        $.getJSON('library/plugins/echarts/doc/example/geoJson/USA_geo.json', callback);
    },
    specialArea : {
    ...
    series : [
        {
            ...
            data:[
	         ...
	         $('#map7').css({width:'800px',height:'320px'});
	         var myChart = ec.init($('#map7')[0]);
