define([ 'text!reporterTpl/mix/mix8/mix8.html'  ,'echarts',
             'echarts/chart/bar','echarts/chart/line','echarts/chart/k' ],function(lineTpl ,echarts){
	return { 
...
myChart2 = echarts.init(document.getElementById('mix81'));
...
var myChart = echarts.init($('#mix8')[0]);
	 myChart.setOption(option) ;
/*
$('#emain').css({width:'350px',height:'320px'});
var myChart = ec.init($('#emain')[0]);
	 myChart.setOption(option) ;


$('#emain2').css({width:'350px',height:'320px'});
var myChart2 = ec.init($('#emain2')[0]);
	 myChart.2setOption(option2) ;
	 */

myChart3 = echarts.init(document.getElementById('mix82'));
