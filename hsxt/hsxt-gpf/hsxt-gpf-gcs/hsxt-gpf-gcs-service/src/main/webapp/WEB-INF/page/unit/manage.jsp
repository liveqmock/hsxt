		...
		<tr style="text-align: left; background-image: url(../images/table_b.png); background-repeat: repeat-x; background-position: left center;">
			...
			<td width="93%">
			              语言代码：<select id="languageCodes_q"></select>&nbsp;
		                            计量单位代码：<input type="text" id="unitCode" >&nbsp;
				计量单位名称：<input type="text" id="unitName" >&nbsp;
	...
	<form id="listForm">
		<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#cccccc">
			<tr style="text-align: center; background-image: url(../images/table_b.png); background-repeat: repeat-x; background-position: left center;">
				...
				<th style="width: 25%">计量单位代码</th>
				<th style="width: 25%">计量单位名称</th>
		...
		<form id="editForm">
			<table width="100%" border="0" cellpadding="5" cellspacing="1">
				<tbody>
					...
					<tr>
						<td align="right">计量单位代码：</td>
						<td align="left">
							<input type="text" name="unitCode" reg="[^\s]">
						</td>
					</tr>
					<tr>
						<td align="right">计量单位名称：</td>
						<td align="left">
							<input type="text" name="unitName" reg="[^\s]">
						</td>
					</tr>
				</tbody>
			</table>
...
<script type="text/javascript">
	...
	var obj = {
					...
					function(data) {
						...
						if (list.length >= 1) {
							for ( var i = 0; i < list.length; i++) {
								...
								html += '<td title="unitCode">' + objValue.unitCode + '</td>';
								html += '<td title="unitName">' + objValue.unitName + '</td>';
								html += '<td><a href="#s" onclick="obj.edit(this);">修改</a> | <a href="#s" onclick="obj.del(\'' + objValue.languageCode + '\',\'' + objValue.unitCode + '\');">删除</a></td>';
								html += '</tr>';
							}
						}
						$('#tbd').html(html);
		...
		edit : function(ths) {
			...
			opens.openDiv('#editFormDiv', '修改计量单位', 500, 420, function(objs) {
				var isSubmit = true;
		...
		//删除
		del : function(languageCode,unitCode) {
