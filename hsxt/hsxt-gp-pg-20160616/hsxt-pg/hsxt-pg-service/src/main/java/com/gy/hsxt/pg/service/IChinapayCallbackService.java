 ...
 * 
 *  File Name       : IPaymentCallbackService.java
 * 
 ...
 * </PRE>
 ***************************************************************************/
public interface IChinapayCallbackService {
	 ...
	 * @throws Exception
	 */
	public void fetchAndNotifyBindingNo(String priv1, String bankOrderNo,
			int merType) throws Exception;
}
