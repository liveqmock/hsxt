 ...
 * </PRE>
 ***************************************************************************/
public abstract class ParentTransCashPost extends
		AbstractAppContextAwareServcie implements ITransCashPost {
	...
	@Autowired
	protected TPgPinganOrderMapper pinganOrderMapper;
	 ...
	 */
	@Override
	public TPgPinganOrder qrySingleTransferFromPA(String bankOrderNo) {
	 ...
	 */
	@Override
	public List<TPgPinganOrder> qryBatchTransferFromPA(String bankBatchNo) {

		PackageDTO packageDTO = null;
		TPgPinganOrder pinganOrder = null;

		List<TPgPinganOrder> resultList = new ArrayList<TPgPinganOrder>(10);
	 ...
	 * @return
	 */
	protected TPgPinganOrder convert2TPgPinganOrder(String bankOrderNo,
		...
		// String failedReason = StringUtils.avoidNull(resBody.getBackRem());
