...
import com.gy.hsxt.pg.service.impl.parent.BaseAccountingFileService;
...
public class ChinapayDayBalanceFileService extends BaseAccountingFileService
	...
	private TPgChinapayDayBalance initChinapayDayBalance(String downloadUrl)
		...
		dayBalance.setId(TimeSecondsSeqWorker.timeNextId16(null));
