...
public class BPConstants {
     ...
     * 获取统一更新版本的业务参数
     * 
     * @return 统一更新版本的业务参数Map
     */
    public static Map<String, String> getbusinessParamEdition() {

        String[] editions = PropertyConfigurer.getProperty("bp.businessParam.edition").split("\\|");

        Map<String, String> editionMap = new HashMap<String, String>();

        // 业务参数
        for (String edition : editions)
        {
            editionMap.put(edition, edition);
        }
