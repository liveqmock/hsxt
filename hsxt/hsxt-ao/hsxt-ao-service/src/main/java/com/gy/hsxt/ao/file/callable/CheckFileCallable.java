...
*/
package com.gy.hsxt.ao.file.callable;
    ...
    public void run() {
        try {
            ...
            if (value == this.checkInfo.getCheckNum()) {
                ...
                checkInfo.getFileInfos().add(AoConfig.DATA_END);// 文件结束标识

                // 调用生成check文档方法
                FileUtils.writeLines(file, AoConfig.DEFAULT_CHARSET, checkInfo.getFileInfos(), "");
