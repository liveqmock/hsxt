...
public interface PsAcImbalanceMapper {

	/**
	 * 查询消费积分系统PS 与账务系统AC 对账不平衡记录数
	 * 
	 * @param beginDate
	 *            对账开始日期 格式YYYY-MM-DD
	 * @param endDate
	 ...
	 * @return
	 */
	List<PsAcImbalance> pagination(@Param("beginDate") String beginDate,
			@Param("endDate") String endDate,
			@Param("imbalanceType") Integer imbalanceType,
