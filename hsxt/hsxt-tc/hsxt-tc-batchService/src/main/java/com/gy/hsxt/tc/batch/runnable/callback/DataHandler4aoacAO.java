...
/**
 * AO-AC对账之AO端数据文件内容拆解及入库
 * 
 * @Package: com.gy.hsxt.tc.batch.runnable.callback
 * @ClassName: DataHandler4bsacAO
 * @Description: TODO
 * 
 * @author: lvyan
 ...
 * @version V1.0
 */
public class DataHandler4aoacAO extends DataHandlerAbstract {
    /**
     * 账单入库表名称
     */
    public static final String MY_TABLE = "T_TC_AOAC_AO_TMP";
    ...
    public DataHandler4aoacAO(TcAoacMapper batchMapper, RedisTemplate redisTemplate) {
    ...
    public String generateCheckKey(String[] args) {
        ...
        // AO-AC 对账要素：客户号|账户类型|增向金额|减向金额|交易流水号|业务记账分录ID
