...
/**
 * PS-AC对账之AC端数据文件内容拆解及入库
 * 
 * @Package: com.gy.hsxt.tc.batch.runnable.callback
 * @ClassName: DataHandler4psacAC
 * @Description: TODO
 * 
 * @author: lvyan
 ...
 * @version V1.0
 */
public class DataHandler4psacAC extends DataHandlerAbstract {
    /**
     * 账单入库表名称
     */
    public static final String MY_TABLE = "T_TC_PSAC_AC_TMP";
    ...
    public DataHandler4psacAC(TcPsacMapper batchMapper, RedisTemplate redisTemplate) {
