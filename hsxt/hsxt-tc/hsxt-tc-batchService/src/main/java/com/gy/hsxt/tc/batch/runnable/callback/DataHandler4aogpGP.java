...
/**
 * AOGP对账之GP端数据文件内容拆解及入库
 * 
 * @Package: com.gy.hsxt.tc.batch.runnable.callback
 * @ClassName: DataHandler4aogpGP
 * @Description: TODO
 * 
 * @author: lvyan
 ...
 * @version V1.0
 */
public class DataHandler4aogpGP extends DataHandlerAbstract {
    /**
     * 账单入库表
     */
    public static final String MY_TABLE = "T_TC_AOGP_GP_TMP";
    ...
    public DataHandler4aogpGP(TcAogpMapper batchMapper, RedisTemplate redisTemplate) {
