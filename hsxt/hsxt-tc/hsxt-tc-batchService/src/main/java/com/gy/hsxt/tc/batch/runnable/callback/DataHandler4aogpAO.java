...
/**
 * AOGP对账之AO端数据文件内容拆解及入库
 * 
 * @Package: com.gy.hsxt.tc.batch.runnable.callback
 * @ClassName: DataHandler4aogpAO
 * @Description: TODO
 * 
 * @author: lvyan
 ...
 * @version V1.0
 */
public class DataHandler4aogpAO extends DataHandlerAbstract {
    /**
     * 账单入库表
     */
    public static final String MY_TABLE = "T_TC_AOGP_AO_TMP";
    ...
    public DataHandler4aogpAO(TcAogpMapper batchMapper, RedisTemplate redisTemplate) {
