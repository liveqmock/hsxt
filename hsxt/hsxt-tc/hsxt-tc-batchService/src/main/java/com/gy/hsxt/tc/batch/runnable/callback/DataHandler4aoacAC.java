...
/**
 * AO-AC对账之AC端数据文件内容拆解及入库
 * 
 * @Package: com.gy.hsxt.tc.batch.runnable.callback
 * @ClassName: DataHandler4bsacAC
 * @Description: TODO
 * 
 * @author: lvyan
 ...
 * @version V1.0
 */
public class DataHandler4aoacAC extends DataHandlerAbstract {
    /**
     * 账单入库表名称
     */
    public static final String MY_TABLE = "T_TC_AOAC_AC_TMP";
    ...
    public DataHandler4aoacAC(TcAoacMapper batchMapper, RedisTemplate redisTemplate) {
