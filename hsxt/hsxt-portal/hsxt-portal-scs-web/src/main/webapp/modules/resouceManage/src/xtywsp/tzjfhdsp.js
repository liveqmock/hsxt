define(['text!resouceManageTpl/xtywsp/tzjfhdsp.html',
...
],function( tzjfhdspTpl ,cyqyzgyzxTpl, ddqptspTpl, dfwgsspTpl, dqptspbhTpl, fwgsspbhTpl,spTpl ){
	return {	 	
				...
				operate : {	
					detail : function(record, rowIndex, colIndex, options){
						...
						var link1 =  $('<a  >查看</a>').click(function(e) {	
							...
							switch (zt){
								case '待服务公司审批':
									$('#tzjfhdsp_dialog>p').html(self.dfwgsspTpl);										
									break;
								case '服务公司审批驳回':
									$('#tzjfhdsp_dialog>p').html(self.fwgsspbhTpl);
									break;
								case '待地区平台审批':
									$('#tzjfhdsp_dialog>p').html(self.ddqptspTpl);
									break;
								case '地区平台审批驳回':
									$('#tzjfhdsp_dialog>p').html(self.dqptspbhTpl);
									break;
								case '地区平台审批通过':
									$('#tzjfhdsp_dialog>p').html(self.cyqyzgyzxTpl);
									break;	
							} 
					...
					add : function(record, rowIndex, colIndex, options){
						...
						var link1 =  $('<a >审批</a>').click(function(e) {				 
							...
							$('#tzjfhdsp_dialog>p').html(self.spTpl);
							$('#tzjfhdsp_dialog').dialog({
								title:'待服务公司审批',
								width:600 ,
								buttons:{
