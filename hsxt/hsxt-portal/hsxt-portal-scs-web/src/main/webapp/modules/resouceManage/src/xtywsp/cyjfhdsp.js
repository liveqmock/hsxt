define(['text!resouceManageTpl/xtywsp/cyjfhdsp.html',
		   ...
		   'text!resouceManageTpl/xtywsp/dialog/sp.html'		],function( cyjfhdspTpl  ,cyqyzgyzxTpl, ddqptspTpl, dfwgsspTpl, dqptspbhTpl, fwgsspbhTpl,spTpl){
	return {	 	
			...
			//Todo...
		 	...
		 	var testData =[
			    {qyglh:'05001000001',qymc:'北京有限公司',qydz:'天安门附近',lxrxm:'张三',lxrsj:'18888888888',zt:'待服务公司审批',ztrq:'2014-12-12'},
			 	...
			 	{qyglh:'05001000001',qymc:'北京有限公司',qydz:'天安门附近',lxrxm:'张三',lxrsj:'18888888888',zt:'地区平台审批通过',ztrq:'2014-12-12'}
			];
				...
				operate : {	
					detail : function(record, rowIndex, colIndex, options){
						...
						var link1 =  $('<a  >查看</a>').click(function(e) {	
							...
							switch (zt){
								case '待服务公司审批':
									$('#cyjfhdsp_dialog>p').html(self.dfwgsspTpl);										
									break;
								case '服务公司审批驳回':
									$('#cyjfhdsp_dialog>p').html(self.fwgsspbhTpl);
									break;
								case '待地区平台审批':
									$('#cyjfhdsp_dialog>p').html(self.ddqptspTpl);
									break;
								case '地区平台审批驳回':
									$('#cyjfhdsp_dialog>p').html(self.dqptspbhTpl);
									break;
								case '地区平台审批通过':
									$('#cyjfhdsp_dialog>p').html(self.cyqyzgyzxTpl);
									break;	
							} 
					...
					add : function(record, rowIndex, colIndex, options){
						...
						var link1 =  $('<a >审批</a>').click(function(e) {				 
							...
							$('#cyjfhdsp_dialog>p').html(self.spTpl);
							$('#cyjfhdsp_dialog').dialog({
								title:'待服务公司审批',
								width:600 ,
								buttons:{
