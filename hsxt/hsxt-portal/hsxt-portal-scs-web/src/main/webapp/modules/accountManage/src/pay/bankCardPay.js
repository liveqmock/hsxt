define(['text!accountManageTpl/pay/bankCardPay.html', 'accountManageDat/hsbzh/hsbzh'], 
		function(bankCardPayTpl,accountManage){
	var pingAnPayFun = {
		showPage : function(obj){
			...
			$('#bankCardPay').click(function(){
				...
				//获取支付跳转url地址
				accountManage.convertPay(param ,function(resp){
