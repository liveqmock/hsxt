define(['text!coDeclarationTpl/qysbcx/cyqysbtj.html',
        'coDeclarationSrc/qysbxz/tab',
        'coDeclarationDat/qysbcx/cyqysbtj',
        'coDeclarationLan'],function(cyqysbtjTpl, qysbxzTab, dataModoule){
	return {	 	
		showPage : function(){
			var self = this;
			$('#cx_content_list').html(_.template(cyqysbtjTpl)) ;
