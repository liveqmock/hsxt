...
Strophe.Connection = function (service, options)
{
    ...
    this._idleTimeout = setTimeout(this._onIdle.bind(this), 1000);
...
Strophe.Connection.prototype = {
    ...
    */
    ...
    disconnect: function (reason)
    {
        ...
        if (this.connected) {
          ...
          //  this._disconnectTimeout = this._addSysTimedHandler(
            ...
            this._disconnectTimeout = this._addSysTimedHandler(
                    200, this._onDisconnectTimeout.bind(this));
    ...
    _onIdle: function ()
    {
        ...
        if (this.connected) {
            this._idleTimeout = setTimeout(this._onIdle.bind(this), 5*1000);
        }
    }
};
...
Strophe.Bosh.prototype = {
        ...
        if (this._requests.length > 0) {
            ...
            if (this._requests[0].dead !== null) {
               ...
               // }
                ...
                if (this._requests[0].timeDead() > 200) {
                this._throttledRequestHandler();
            }
            }
    ...
    _processRequest: function (i)
    {
      ...
      //                        time_elapsed > Math.floor(Strophe.TIMEOUT * this.wait));
        ...
        var primaryTimeout = 100;
        var secondaryTimeout = 150;
    ...
    _send: function () {
        ...
        this._throttledRequestHandler();
        this._conn._idleTimeout = setTimeout(this._conn._onIdle.bind(this._conn), 1000);
    },
...
Strophe.Websocket.prototype = {
    ...
    _connect: function () {
        ...
        this._closeSocket();
        if (!window.WebSocket || !WebSocket){return;};
