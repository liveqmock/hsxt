define(function(){
	var ajaxRequest = {
		...
		//暂停启用网上商城
		changeVshopStatus : function(param, callback) {
			comm.Request({url:'changeVshopStatus',domain:'scs'}, {
				type : 'POST',
				data : param,
				dataType : "json",
				success : function(response){
		...
		//删除手机图片
		deleteVirtualShopPics : function(param, callback){
			comm.Request({url:'deleteVirtualShopPics',domain:'scs'}, {
				type : 'POST',
				data : param,
				dataType : "json",
				success : function(response){
