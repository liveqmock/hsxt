define(['text!reporterTpl/tree/tree1/line.html'  ,'echarts',
                'echarts/chart/tree','echarts/chart/line' ],function(lineTpl ,ec){
	return { 
    ...
    series : [
        ...
        $('#tree1').css({width:'800px',height:'320px'});
         var myChart = ec.init($('#tree1')[0]);
