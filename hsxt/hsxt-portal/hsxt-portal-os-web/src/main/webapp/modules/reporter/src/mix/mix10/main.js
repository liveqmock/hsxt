define([ 'text!reporterTpl/mix/mix10/mix10.html' ,'echarts',
               'echarts/chart/bar','echarts/chart/k' ,'echarts/chart/pie','echarts/chart/gauge' ,'echarts/chart/funnel' ],function(lineTpl ,ec){
	return { 
    ...
    series : [
        ...
        },
        {
            ...
            data:[ // 开盘，收盘，最低，最高
	         ...
	         $('#mix10').css({width:'800px',height:'320px'});
	         var myChart = ec.init($('#mix10')[0]);
