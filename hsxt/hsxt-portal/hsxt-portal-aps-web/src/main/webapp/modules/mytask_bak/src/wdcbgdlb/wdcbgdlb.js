define(['text!mytaskTpl/wdcbgdlb/wdcbgdlb.html',
		'text!mytaskTpl/wdcbgdlb/wdcbgdlb_ck.html'
		], function(wdcbgdlbTpl, wdcbgdlb_ckTpl){
	return {
		showPage : function(){
			$('#busibox').html(_.template(wdcbgdlbTpl)).append(wdcbgdlb_ckTpl);	
		...
		chakang : function(){
			$('#wdcbgdlbTpl').addClass('none');
			$('#wdcbgdlb_ckTpl').removeClass('none');
			comm.liActive_add($('#cknr'));
			$('#back_wdcbgdlb').triggerWith('#wdcbgdlb');
		},
		banli : function(){
			alert('办理');
		}
