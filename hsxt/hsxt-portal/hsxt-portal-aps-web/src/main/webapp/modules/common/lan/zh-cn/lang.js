define([ "commSrc/comm" ], function() {
	comm.langConfig["common"] = {
		...
		errorCodes : {
			...
			"22031" : "上传文件不能为空",
			"22032" : "上传文件不是有效的Excel文件",
			"22033" : "解析Excel文件失败，请检查文件内容.",
			"22034" : "上传文件内容不能为空.",
			"36256" : "KSN码1附件不能为空.",
			"36257" : "KSN码2附件不能为空.",
			"36258" : "KSN码3附件不能为空.",
		...
		samplePicEnum :{
			...
			1011:'户籍注销证明',
			1012:'与被保障人关系证明',
//			1013:'企业实地考察报告扫描件',/**2016-04-21去掉*/
//			1014:'企业双方声明文件扫描件',/**2016-04-21去掉*/
			1015:'互生卡正面',
			1016:'互生卡背面',
			1017:'医疗证明',
			1018:'死亡证明',
		...
		sampleComEnum :{
			...
			1002:'互生系统应用合同(服务公司)',
			1003:'互生系统应用合同(托管企业)',
			1004:'企业参与“消费100以上送5000消费抵扣券”活动协议书',
			1005:'企业应用互生系统申报信息登记表',
			1006:'互生系统区域服务公司与创业人员（创业帮扶）协议',
			1007:'联系人授权委托书',
			1008:'企业实地考察报告',
			1009:'企业双方声明文件',
			1010:'个性卡定制确认书',
			1011:'互生系统应用合同(免费成员企业)'
		},
		codesIsNull:'验证码不能为空',
		codesIsInvalid:'请输入四位数验证码',
		requestFailed:'请求失败...',
		...
		select_verificationMode_prompt:"请选择验证方式",
		/**其他*/
