define(['text!systemManageTpl/jsgl/xzxgjs.html',/* ,'text!systemManageTpl/jsgl/xzxgjs_dialog.html' */
        'systemManageDat/systemManage'],function(xzxgjsTpl/* ,xzxgjs_dialogTpl */,systemManage){
	var xzxgjsPage = {
		 	...
		 	$('#jsgl_qr').click(function(){
		 		...
		 		if(updataFlag == "1"){
		 			...
		 			systemManage.updateRole(postData,function(res){
		 				...
		 				xzxgjsPage.menuAuth($("#roleId").val(),comm.lang("systemManage").updateRoleGrantMenu);
//		 				$("#xtyhgl_jsgl").click();
		 		...
		 		//添加
	 				...
	 				systemManage.addRole(postData,function(res){
	 					...
	 					xzxgjsPage.menuAuth(roleId,comm.lang("systemManage").addRoleGrantMenu);
			...
			//取消
			$('#btn_back').triggerWith('#xtyhgl_jsgl');	
		},
		
		//菜单授权
		menuAuth : function(roleId,title){
