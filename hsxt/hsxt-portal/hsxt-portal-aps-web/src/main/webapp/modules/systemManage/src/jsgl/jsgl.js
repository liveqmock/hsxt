define(['text!systemManageTpl/jsgl/jsgl.html' ,
		...
		'jqueryztree'			 
			],function(jsglTpl ,cdsqTpl,systemManage){
	var jsglPage = {
		loginInfo : null,
		gridObj : null,
		showPage : function(){
			...
			$('#busibox').html(_.template(jsglTpl)) ;			 
		 	
		 	//添加
		 	$('#btn_tjjs').triggerWith('#xtyhgl_xzjs');
			...
			$("#searchBtn").click(function(){
				...
				var params = {
						...
						search_roleName:$("#searchRoleName").val()
//						search_roleType : ''		//角色类型
				};
				gridObj = comm.getCommBsGrid("detailTable","list_role",params,comm.lang("systemManage"),jsglPage.detail,jsglPage.del,jsglPage.edit);
  			...
  			var link1 = '';
	  				link1 =  $('<a >'+comm.lang("systemManage").del+'</a>').click(function(e) {	
						...
						var confirmObj = {	
							imgFlag:true,
							width:480,
							content : comm.lang("systemManage").delContent + "<font color='red'>" + record.roleName + "</font>" + comm.lang("systemManage").delRole,									 													
							callOk :function(){
