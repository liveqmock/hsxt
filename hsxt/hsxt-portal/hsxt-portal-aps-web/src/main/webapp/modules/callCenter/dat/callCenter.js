...
define(function () {
    return {
        ...
        getPersonAllInfo : function (params,callback){
            comm.requestFun("getPersonAllInfo", params,callback, comm.lang("common"));
        },
        ...
        getAccountBalance : function (params,callback){
            comm.requestFun("getAccountBalance", params,callback, comm.lang("common"));
        },
        //消费者今日积分查询
        searchPerIntegralByToday : function (params,callback){
            comm.requestFun("searchPerIntegralByToday", params,callback, comm.lang("common"));
        },
        //企业昨日积分查询
        searchEntIntegralByYesterday : function (params,callback){
            comm.requestFun("searchEntIntegralByYesterday", params,callback, comm.lang("common"));
        },
        //投资查询
        findInvestDividendInfo:function(params,callback){
          comm.requestFun("findInvestDividendInfo",params,callback,comm.lang("common"))
        },
        //查询积分福利资格 param resNo
        getWelfareQualify : function (params,callback){
            comm.requestFun("getWelfareQualify", params,callback, comm.lang("common"));
        },
        //积分福利信息查询，包括历史保单
        ...
        searchEntContactInfo : function (params,callback){
            comm.requestFun("searchEntContactInfo", params,callback, comm.lang("common"));
        },
        //企业所有信息查询  用于呼叫中心右上角
        searchEntAllInfo : function (params,callback){
            comm.requestFun("searchEntAllInfo", params,callback, comm.lang("common"));
        },
        //报送服务公司信息查询
        ...
        getBankAccountList : function (params,callback){
            comm.requestFun("getBankAccountList", params,callback, comm.lang("common"));
        },
        //手机号码归属地查询
        getMobilePhoneCity:function(params,callback){
            comm.requestFun("getMobilePhoneCity", params,callback, comm.lang("common"));
        },
        //重要信息变更
        getImptChangeInfo:function(params,callback){
            comm.requestFun("getImptChangeInfo", params,callback, comm.lang("common"));
        },
        //快捷支付卡列表
        getQkBankAccountList:function(params,callback){
            comm.requestFun("getQkBankAccountList", params,callback, comm.lang("common"));
        },
        //操作许可查询
        queryBusinessPmInfo:function(params,callback){
            comm.requestFun("queryBusinessPmInfo", params,callback, comm.lang("common"));
        },
        //呼叫中心报表统计导出
        excelExport:function(params,callback){
            comm.requestFun("excelExport",params,callback,comm.lang("common"));
        },
        //互生系统报表统计
        excelExport1:function(data){
            var param="?";
            for(var str in data){
                if(data[str]!=""){
                    param+=str+"="+data[str]+"&";
            ...
            return comm.domainList["apsWeb"]+comm.UrlList["excelExport"]+param;
        },
        //企业服务公司年费信息查询
        getAnnualFeeInfo:function(params,callback){
            comm.requestFun("getAnnualFeeInfo",params,callback,comm.lang("common"));
        }
    };
});