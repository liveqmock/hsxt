define(['text!coDeclarationTpl/kqxtqksh/qyxtzcxx.html',
        'coDeclarationDat/kqxtqksh/qyxtzcxx',
	...
	return{
		...
		initForm : function(data){
			...
			if(custType == "2"){
				...
				qyxtzcxx = "coDeclarationSrc/kqxtqksh/qyxtzcxx_cyqy";
				...
				$("#view-spreadEntResNoText").html("服务公司互生号");
				$("#view-spreadEntNameText").html("所属服务公司名称");
				qyxtzcxx = "coDeclarationSrc/kqxtqksh/qyxtzcxx_tgqy";
				...
				qyxtzcxx = "coDeclarationSrc/kqxtqksh/qyxtzcxx_fwgs";
