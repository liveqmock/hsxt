define(['text!coDeclarationTpl/sptjcx/tgqysptj.html',
        'coDeclarationDat/sptjcx/tgqysptj',
		'coDeclarationSrc/qyxz/tab',
        'coDeclarationLan'], function(tgqysptjTpl, dataModoule, qysbxzTab){
	return {
		showPage : function(){
			var self = this;
			$('#busibox').empty().html(_.template(tgqysptjTpl));
			//时间控件		    
