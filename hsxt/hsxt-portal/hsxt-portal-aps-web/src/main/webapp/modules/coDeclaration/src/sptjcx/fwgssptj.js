define(['text!coDeclarationTpl/sptjcx/fwgssptj.html',
        'coDeclarationDat/sptjcx/fwgssptj',
		'coDeclarationSrc/qyxz/tab',
        'coDeclarationLan'], function(fwgssptjTpl, dataModoule, qysbxzTab){
	return {
		showPage : function(){
			var self = this;
			$('#busibox').empty().html(_.template(fwgssptjTpl));
			//时间控件		    
