define(['text!toolmanageTpl/ckkcgl/gjrkls.html',
		'toolmanageDat/ckkcgl/gjrkls',
        'toolmanageLan'
		], function(gjrklsTpl, dataModoule){
	return {
		showPage : function(){
			this.initForm();
		},
		...
		initForm : function(){
			var self = this;
			$('#infobox').html(_.template(gjrklsTpl));
		...
		initData : function(){
			...
			dataModoule.findToolEnterSerialList(params, this.detail);
		},
		/**
		 * 详情
		 */
