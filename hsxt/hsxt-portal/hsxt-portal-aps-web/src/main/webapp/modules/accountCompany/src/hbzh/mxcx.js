define(['text!accountCompanyTpl/hbzh/mxcx/mxcx.html',
		'accountCompanyDat/accountCompany'
		], function(tpl, accountCompany){
	return companyHbzhMxcx={
		showPage : function(){
			$('#busibox').html(tpl);
		...
		loadGrid:function(){
			...
			accountCompany.getAccoutGrid("scpoint_result_table",params,companyHbzhMxcx.detail);
		},
