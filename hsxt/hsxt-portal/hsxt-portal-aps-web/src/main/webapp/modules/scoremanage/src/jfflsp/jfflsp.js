/*积分福利初审*/
define([
"text!scoremanageTpl/jfflsp/jfflsp.html",
"text!scoremanageTpl/jfflsp/jfflsp_sp1.html",
"text!scoremanageTpl/jfflsp/jfflsp_sp2.html",
"text!scoremanageTpl/jfflsp/jfflsp_sp3.html",
"text!scoremanageTpl/jfflsp/sh_dialog.html",
'text!scoremanageTpl/jfflsp/jfflsp_gq_dialog.html',
'scoremanageDat/pointWelfare',
'scoremanageLan'
],function(jfflspTpl,jfflsp_sp1Tpl,jfflsp_sp2Tpl,jfflsp_sp3Tpl,sh_dialogTpl,jfflsp_gq_dialog,pointWelfare){
	...
	var self = {
		...
		pageQuery:function(){
			...
			var queryParam={
							...
							"search_appovalStep":0,	//int	是	审批步骤： 0初审 1复审
		...
		detail : function(record, rowIndex, colIndex, options){
		  ...
		  /*  if(colIndex==10){
				var link1 = $('<a>挂起</a>').click(function(e) {
					comm.i_confirm(comm.lang('pointWelfare').cssuspendApproval,function(){
		...
		hangUp : function(record, rowIndex, colIndex, options){
			if(colIndex==10){
				var link = $('<a>'+comm.lang("pointWelfare").hangUp+'</a>').click(function(e) {
					comm.i_confirm(comm.lang("pointWelfare").cssuspendApproval,function(){
						$('#dialogBox_fh_sq').html(_.template(jfflsp_gq_dialog));
		...
		del : function(record, rowIndex, colIndex, options){
			if(colIndex==10){
				var link1 = $('<a>拒绝受理</a>').click(function(e) {
					comm.i_confirm(comm.lang('pointWelfare').csrefuseApproval,function(){
		...
		shenPi_1 : function(record){
			self.getApprovalDetail(record["approvalId"],function(obj){
				...
				obj.subsidyBalance=self.foramtSubsidyBalance(obj.applyInfo.welfareType,record['subsidyBalance']);
				...
				self.showApprovalDialog($('#jfflsp1_btn'),$('#back1_jfflsp'),record["approvalId"]);
		...
		shenPi_2 : function(record){
			self.getApprovalDetail(record["approvalId"],function(obj){
				...
				self.showApprovalDialog($('#jfflsp2_btn'),$('#back2_jfflsp'),record["approvalId"]);
		...
		shenPi_3 : function(record){
			self.getApprovalDetail(record["approvalId"],function(obj){
				...
				self.showApprovalDialog($('#jfflsp3_btn'),$('#back3_jfflsp'),record["approvalId"]);
