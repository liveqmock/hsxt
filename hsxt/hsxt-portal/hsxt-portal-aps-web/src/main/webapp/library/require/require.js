...
var js=document.scripts ,localPath;
...
// 全局路径定义
var globalPath = localPath.replace('library/require/','') ;
var remotePath = ""  ;
...
(function(){
        ...
        { 
             globalLanguage = window.navigator.language  ;	  
			 if ( globalLanguage == 'zh-CN' ){
				 globalLanguage = 'cn' ;
			 } else if (globalLanguage == 'zh-TW' ) {
				 globalLanguage = 'tw' ;
			 } else {
					globalLanguage. substr(0,2) ;
			 }
...
var reqConfig = {
    ...
    shim : {
		...
		'GY' : {
			 deps : ['jquery','jqueryui','jquerycookie','jqueryslide',
			         'jqueryjscrollpane','jquerymousewheel','jqueryselectbox','jquerydataTables',
			         'jqueryvalidate','additionalmethods','jquerycustomer','jqueryuploadPreview',
			         'jqueryajaxfileupload','jqueryalert',			         
			         ,'underscore','commSrc/comm'],
             exports : 'GY'	
		}
    },
    ...
    paths : {
		 ...
		 *
		 */
		es : 'http://www.eshop.com/'   ,
		ms : 'http://www.message.com/' ,
		whc : 'http://192.168.1.13:9000/' ,
	   ...
	   ,
	setLocalPath : function(moduleName) {	 
		//设置本地路径
...
//globalLanguage = 'en' ; 
//reqConfig.paths.commLan =  'modules/common/lan/'+globalLanguage ;
