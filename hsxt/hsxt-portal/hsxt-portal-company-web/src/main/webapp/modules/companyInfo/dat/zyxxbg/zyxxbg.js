define(function () {
	return {
		 ...
		 * @param callback 回调函数
		 */
		createEntChange : function(params, callback,failCallback){
			comm.requestFunForHandFail("createEntChange", params, callback, failCallback,comm.lang("companyInfo"));
		},
		/**
		 * 企业系统信息-查询重要信息变更
		 * @param params 参数对象
		...
		findEntChangeList : function(params, detail){
			comm.getCommBsGrid(null, "findEntChangeList", params, detail);
		}
	};
});