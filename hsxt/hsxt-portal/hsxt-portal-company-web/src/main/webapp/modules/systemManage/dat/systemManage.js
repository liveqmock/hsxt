define(function () {
	return {
		...
		//绑定互生卡
		bindCard : function(params,callback){
			comm.requestFun("bindcard_operator", params, callback, comm.lang("systemManage"));
		},
		//解绑互生卡
		unBindCard : function(params,callback){
			comm.requestFun("unbindcard_operator", params, callback, comm.lang("systemManage"));
		},
		...
		//关联营业点查询
		getSalerStoresByEntResNoAndEmpActNo : function(params,callback){
			comm.requestFun("getSalerStoresByEntResNoAndEmpActNo",params,callback,comm.lang("systemManage"));
		},
		//设置操作员与营业点的关联关系
		setSalerStoreEmployeeRelation : function(params,callback){
			comm.requestFun("setSalerStoreEmployeeRelation",params,callback,comm.lang("systemManage"));
		},
		//清空操作员的营业点
		deleteStore : function(params,callback){
			comm.requestFun("deleteStoreEmployeesByEntResNoAndEmpActNo",params,callback,comm.lang("systemManage"));
		}
