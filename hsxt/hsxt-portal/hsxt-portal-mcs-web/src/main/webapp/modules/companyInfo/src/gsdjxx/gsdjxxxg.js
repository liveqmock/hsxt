	...
	var gsdjxxxgPage = {
		...
		initForm : function(data){
			...
			$('#submitBt_gongshang').click(function(){
				comm.i_confirm(comm.lang("companyInfo").confirmSubmit, function(){
		...
		validateData : function(){
			 var validate = $("#qygsdjxx_form").validate({
				...
				messages : {
					...
					nature : {
						required : comm.lang("companyInfo")[33209],
						rangelength:comm.lang("companyInfo")[33210]
					},
					buildDate : {
						required : comm.lang("companyInfo")[33213],
						date : comm.lang("companyInfo")[33214]
					},
					businessScope : {
						rangelength: comm.lang("companyInfo")[33223]
					},
					endDate : {
						rangelength:comm.lang("companyInfo")[33225]
					}
				},
