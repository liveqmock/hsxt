define(['text!coDeclarationTpl/qysbfk/ckxq/qysczl.html',
    ...
    var mcs_qysbfk_qysczl = {
        creType:null,
        showPage: function () {
            mcs_qysbfk_qysczl.initData();
            mcs_qysbfk_qysczl.initForm();
        },
        /**
         * 初始化界面
         */
        initForm: function () {
            ...
            $('#ckxq_xg').click(function () {
                ...
                if ($(this).text() != '保　存') {
                    ...
                    mcs_qysbfk_qysczl.initChangeData();
                }
            });
        },
        /**
        ...
        initData: function () {
            dataModoule.findAptitudeByApplyId({"applyId": $("#applyId").val()}, function (res) {
                ...
                mcs_qysbfk_qysczl.initShowForm(res.data, false);
            });
        },
        /**
         * 初始化显示页面
        ...
        initShowForm: function (data, isCallBack) {
            ...
            mcs_qysbfk_qysczl.creType = data.creType;
            ...
            //证件类型为护照
            if(mcs_qysbfk_qysczl.creType&&mcs_qysbfk_qysczl.creType==2) {
                $('#case-fileId-1').hide();
                $('#preview-2-div').hide();
            ...
            mcs_qysbfk_qysczl.initTmpPicPreview();
        },
        /**
         * 绑定图片预览
         */
        ...
        validateData: function () {
            ...
            if (mcs_qysbfk_qysczl.creType==2||$("#real-fileId-2").val() != "") {
        ...
        initChangeData: function () {
            if (!mcs_qysbfk_qysczl.validateData().form()) {
                return;
            }
            ...
            mcs_qysbfk_qysczl.getChangePic("#lrCredentialFrontFileId", "#real-fileId-1", "法人代表证件正面", 1);
            if(mcs_qysbfk_qysczl.creType==null||mcs_qysbfk_qysczl.creType != 2) {
                mcs_qysbfk_qysczl.getChangePic("#lrCredentialBackFileId", "#real-fileId-2", "法人代表证件反面", 2);
            }
            mcs_qysbfk_qysczl.getChangePic("#busLicenceFileId", "#real-fileId-3", "营业执照扫描件", 3);
            mcs_qysbfk_qysczl.getChangePic("#organizationFileId", "#real-fileId-6", "组织机构代码证扫描件", 6);
            mcs_qysbfk_qysczl.getChangePic("#taxplayerFileId", "#real-fileId-7", "税务登记证扫描件", 7);
            mcs_qysbfk_qysczl.getChangePic("#venBefProtocolId", "#real-fileId-8", "创业帮扶协议", 8);
            ...
            $('#qysczl_dialog').dialog({
                ...
                buttons: {
                    '确定': function () {
                        if (!mcs_qysbfk_qysczl.validateViewMarkData().form()) {
                            return;
                        }
                        //验证双签
                        comm.verifyDoublePwd($("#doubleUserName").val(), $("#doublePassword").val(), 1, function (verifyRes) {
                            ...
                            comm.uploadFile(null, ids, function (data) {
                                ...
                                mcs_qysbfk_qysczl.saveData(ndata, chg, verifyRes);
                            }, function (err) {
                                mcs_qysbfk_qysczl.initTmpPicPreview();
        ...
        saveData: function (ndata, chg, verifyRes) {
            ...
            params.creType = mcs_qysbfk_qysczl.creType;
            ...
            dataModoule.saveDeclareAptitude(params, function (res) {
                ...
                comm.alert({
                    content: comm.lang("coDeclaration")[22000], callOk: function () {
                        ...
                        mcs_qysbfk_qysczl.initShowForm(ndata, true);
                    }
                });
            });
        },
