define(['text!resouceManageTpl/zypecx/zypecx_tgqy.html',
		'text!resouceManageTpl/zypecx/tgqy_dialog.html'
		],function(zypecxTpl, tgqy_dialogTpl){
	return {
		...
		chaKan : function(){
			$('#tgqy_dialog').html(tgqy_dialogTpl);	
