define(['text!resouceManageTpl/zype/zypeylb_tgqy_xq.html',
		'text!resouceManageTpl/zype/tgqy_zy_dialog.html' 
		],function(zypeylb_xqTpl, tgqy_zy_dialogTpl){
	return {
		...
		chaKan : function(){
			$('#tgqy_dialog').html(tgqy_zy_dialogTpl);	
			
			/*表格数据模拟*/
			var json_tgqy_dialog = [{
							"th_1":"05116000000",
							"th_2":"浙江服务002",
			...
			gridObj = $.fn.bsgrid.init('searchTable_tgqy_dialog', {				 
