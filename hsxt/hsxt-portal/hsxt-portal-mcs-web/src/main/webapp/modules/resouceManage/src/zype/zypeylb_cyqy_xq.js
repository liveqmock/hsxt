define(['text!resouceManageTpl/zype/zypeylb_cyqy_xq.html',
		'text!resouceManageTpl/zype/cyqy_zy_dialog.html'
		],function(zypeylb_xqTpl, cyqy_zy_dialogTpl){
	return {
		...
		chaKan : function(){
			$('#cyqy_dialog').html(cyqy_zy_dialogTpl);	
