define(["text!safetySetTpl/setDelPassword.html","safetySetLan"], function (tpl) {
	var setDelPassword = {
		show : function(dataModule){
			...
			//初始化交易密码长度
			dataModule.initTradePwd(null,function(response){
				
				delPwdLength = response.data.tradingPasswordLength;
				//保存交易密码长度
