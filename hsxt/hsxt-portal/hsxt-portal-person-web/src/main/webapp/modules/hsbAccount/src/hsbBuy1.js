define(["text!hsbAccountTpl/hsbBuy.html", "text!hsbAccountTpl/hsbBuy_cashpay_bak.html", "text!hsbAccountTpl/hsbBuy_ebankpay_bak.html"], function (tpl, tplCashpay, tplEbankpay) {
	var hsbBuy = {
