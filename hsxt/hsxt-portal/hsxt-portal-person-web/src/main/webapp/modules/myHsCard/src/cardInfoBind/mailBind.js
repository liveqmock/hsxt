define(["text!myHsCardTpl/cardInfoBind/mailBind.html",
		"text!myHsCardTpl/cardInfoBind/mailBind2.html",
		"text!myHsCardTpl/cardInfoBind/mailBind3.html"
				...
				comm.getToken(null,function(rsp){
					...
					dataModule.mailModify(jsonParam,function (response) {
						if (response.retCode ==22000){
							...
							$("#myhs_kxxbd a[class='a_select']").click();
