define(["text!myHsCardTpl/cardInfoBind/MyFastPaymentCard.html",
		'text!myHsCardTpl/cardInfoBind/pay/openQuickPay.html',
		'text!myHsCardTpl/cardInfoBind/pay/qPayRegistered.html',
		'text!myHsCardTpl/cardInfoBind/pay/moreCredit.html',
		'text!myHsCardTpl/cardInfoBind/pay/moreStorageCard.html',
		'text!myHsCardTpl/cardInfoBind/pay/kjzffwxy.html',
		"myHsCardLan"
	], function (MyFastPaymentCardTpl, openQuickPayTpl, qPayRegisteredTpl, moreCreditTpl, moreStorageCardTpl, kjzffwxyTpl) {
	var mailBind = {
		_dataModule : null,
		show : function(dataModule){
			...
			//加载页面
			$("#kxxbd_content").html(MyFastPaymentCardTpl);
			//加载数据
			self.findPayBanks();
