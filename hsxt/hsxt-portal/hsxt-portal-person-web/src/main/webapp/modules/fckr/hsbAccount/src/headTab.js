define(["text!fckr_hsbAccountTpl/headTab.html",
		"fckr_hsbAccountDat/hsbAccount",
		"fckr_hsbAccountSrc/balanceInquiry",
		"fckr_hsbAccountSrc/hsbToCash",
		"fckr_hsbAccountSrc/hsbBuy",
		"fckr_hsbAccountSrc/detailSearch",
		"fckr_hsbAccountSrc/zfxesz"
