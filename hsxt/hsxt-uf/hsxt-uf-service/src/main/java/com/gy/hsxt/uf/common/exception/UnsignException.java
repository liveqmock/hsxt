 ...
 * 
 *  File Name       : UnsignException.java
 * 
 ...
 * </PRE>
 ***************************************************************************/
public class UnsignException extends Exception {
	...
	public UnsignException(String errorMsg) {
		super(errorMsg);

		this.setErrorMsg(errorMsg);
	}

	public UnsignException(int errorCode, String errorMsg) {
		super(errorMsg);
	...
	public UnsignException(int errorCode, String errorMsg, Throwable throwable) {
		this(errorCode, errorMsg);
	}

	public UnsignException(String errorMsg, Throwable throwable) {
		super(errorMsg, throwable);
	}

	public UnsignException(Throwable throwable) {
		super(throwable);
	}
