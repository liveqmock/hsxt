 ...
 * 
 * @Package: com.gy.hsi.nt.server.listener
 * @ClassName: HighQueueListener
 * @Description: TODO
 * @author: likui
 * @date: 2016年3月26日 下午12:29:40
 * @company: gyist
 * @version V3.0.0
 */
public class HighQueueListener implements MessageListener {

	private static final Logger logger = Logger.getLogger(HighQueueListener.class);
	...
	public void onMessage(Message message)
	{
		...
		try
		{
			logger.info("高优先级MQ监听器接收到消息");
			// Object obj =
			// (Object)SerializationUtils.deserialize(message.getBody());
		...
		{
			logger.error("消息发送异常,消息实体:" + JSONObject.toJSONString(json), e);
		}
	}
}
