 ...
 * 
 * @Package: com.gy.hsi.nt.server.listener
 * @ClassName: LowQueueListener
 * @Description: TODO
 * @author: likui
 * @date: 2016年3月26日 下午2:05:50
 * @company: gyist
 * @version V3.0.0
 */
public class LowQueueListener implements MessageListener {

	private static final Logger logger = Logger.getLogger(LowQueueListener.class);
