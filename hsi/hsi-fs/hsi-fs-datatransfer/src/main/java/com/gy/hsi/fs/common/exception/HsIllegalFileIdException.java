 ...
 * </PRE>
 ***************************************************************************/
public class HsIllegalFileIdException extends RuntimeException {

	private static final long serialVersionUID = -7249572867399040181L;
	protected String errorMsg = "";
	protected String fileId = "";

	public HsIllegalFileIdException() {
	}

	public HsIllegalFileIdException(String errorMsg, String fileId) {
		super(errorMsg);
	...
	public HsIllegalFileIdException(Throwable throwable) {
