...
public class TEntExtend {
    ...
    public Short getCredentialType() {
        return credentialType;
    }

    public void setCredentialType(Short credentialType) {
    ...
    public Short getArtResTypest() {
        return artResTypest;
    }

    public void setArtResTypest(Short artResTypest) {
