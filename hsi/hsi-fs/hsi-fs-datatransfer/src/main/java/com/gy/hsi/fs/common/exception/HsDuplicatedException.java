 ...
 * </PRE>
 ***************************************************************************/
public class HsDuplicatedException extends RuntimeException {

	private static final long serialVersionUID = -7249572867399040181L;
	protected String errorMsg = "";
	protected String fileId = "";

	public HsDuplicatedException() {
	}

	public HsDuplicatedException(String errorMsg, String fileId) {
		super(errorMsg);
	...
	public HsDuplicatedException(Throwable throwable) {
