...
import com.gy.hsi.ds.login.beans.bo.RoleResource;
import com.gy.hsi.ds.login.dao.IRoleResourceDao;
 ...
 */
@Service
public class RoleResourceMgrImpl implements IRoleResourceMgr {

    protected final static Logger LOG = AopLogFactory.getLogger(RoleResourceMgrImpl.class);

    @Autowired
    private IRoleResourceDao roleResDao;
