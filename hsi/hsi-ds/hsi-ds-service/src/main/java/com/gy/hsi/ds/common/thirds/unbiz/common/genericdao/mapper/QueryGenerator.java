package com.gy.hsi.ds.common.thirds.unbiz.common.genericdao.mapper;
...
import com.gy.hsi.ds.common.thirds.unbiz.common.genericdao.dao.GenericDao;
...
import com.gy.hsi.ds.common.thirds.unbiz.common.genericdao.operator.Query;
import com.gy.hsi.ds.common.thirds.unbiz.common.genericdao.param.AppenderParam;
import com.gy.hsi.ds.common.thirds.unbiz.common.genericdao.param.BetweenParam;
import com.gy.hsi.ds.common.thirds.unbiz.common.genericdao.param.ExpressionParam;
import com.gy.hsi.ds.common.thirds.unbiz.common.genericdao.param.GreaterThanParam;
import com.gy.hsi.ds.common.thirds.unbiz.common.genericdao.param.GteParam;
import com.gy.hsi.ds.common.thirds.unbiz.common.genericdao.param.IncrParam;
import com.gy.hsi.ds.common.thirds.unbiz.common.genericdao.param.LessThanParam;
...
public class QueryGenerator<ENTITY extends BaseObject<KEY>, KEY extends Serializable> {
    ...
    public void appendMatches(Collection<Match> matches, StringBuilder sb, List<Object> params) {
    	...
    	AppenderParam appenderParam = null;
    	...
    	for (Match match : matches) {
            ...
            if(value instanceof AppenderParam) {
            	appenderParam = (AppenderParam)value;
        ...
        if(null != appenderParam) {
        	sb.append(" ").append(appenderParam.getSql());
        }
    }
