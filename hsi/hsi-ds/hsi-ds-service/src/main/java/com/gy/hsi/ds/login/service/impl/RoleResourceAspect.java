...
import com.gy.hsi.ds.common.constant.RoleResourceConstant;
...
import com.gy.hsi.ds.login.service.IRoleResourceMgr;
...
public class RoleResourceAspect {
    ...
    @Autowired
    private IRoleResourceMgr roleResMgr;
     ...
     * @throws Throwable
     */
    @Around("anyPublicMethod() && @annotation(requestMapping) && !@annotation(com.gy.hsi.ds.common.thirds.dsp.common.annotation.NoAuth)")
